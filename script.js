...
const fairSteps = [
 ['A place to begin','A welcome that makes the next step clear.','Volunteers explain the available services, ask about language preferences, and help participants choose where to begin. Participation is voluntary.','Student volunteers and community partners','A clear introduction to the services and people available.','altadena-community-clean-ground.jpg','Student volunteers, physicians, and community partners at a health fair.'],
 ['Preventive care','A screening. A conversation.','At participating stations, trained personnel offer screenings such as blood pressure or blood glucose checks, with clinical oversight appropriate to the service. Qualified professionals explain results and recommend next steps.','Trained screening personnel and healthcare professionals','An opportunity to discuss a result and ask questions.','altadena-screening-team-framed.jpg','Volunteers at the blood pressure and blood glucose screening table.'],
 ['Making care accessible','Help finding a way into care.','Participants can ask about health insurance enrollment and local care options. Qualified enrollment partners explain available pathways; volunteers help people locate the appropriate resource station.','Enrollment specialists and resource-navigation partners','A clearer understanding of where to seek assistance.','altadena-resources-focus.jpg','Volunteers behind the This Way to Health Insurance banner.'],
 ['Practical support','Resources to take home.','Essential supplies complement the day’s health services. Volunteers distribute available health and hygiene kits, with contents guided by community needs and partner requests.','Student volunteers and distribution partners','Useful supplies and information beyond the event.','altadena-supplies-finished.jpg','Prepared health and hygiene kits on a distribution table.'],
 ['Beyond the event','Leave with a clearer next step.','Where referrals are available, participants should leave with a named service, contact information, and an explanation of how to reach it. Developing consent-based follow-up with partners is a priority for future programming.','Healthcare professionals and referral partners','A pathway toward continued care, with follow-up still being developed.','altadena-resources-focus.jpg','The health insurance resource station at a community fair.']
];
let fairIndex=0;
const fairTabs=[...document.querySelectorAll('[data-fair-step]')];
function showFairStep(index,focus=false){
 fairIndex=index;
 const [kicker,heading,description,team,result,photo,alt]=fairSteps[index];
 for(const [id,value] of Object.entries({'fair-kicker':kicker,'fair-heading':heading,'fair-description':description,'fair-team':team,'fair-result':result,'fair-stage':`0${index+1} / 05`,'fair-progress':`Station ${index+1} of 5`}))document.getElementById(id).textContent=value;
 const img=document.getElementById('fair-photo');img.src=`assets/${photo}`;img.alt=alt;
