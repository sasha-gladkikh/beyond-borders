...
page=f'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Common Ground | By Beyond Borders</title><meta name="description" content="Research commentary and perspectives on displacement, health, and access to care."><link rel="icon" href="assets/mark.png"><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Manrope:wght@400;600;700;800&family=Source+Sans+3:wght@400;500;600;700&display=swap"><link rel="stylesheet" href="styles.css?v=39"><link rel="stylesheet" href="journal.css?v=8"><link rel="stylesheet" href="common-ground-editorial-type.css?v=1"></head><body class="journal-page gazette-home"><a class="skip-link" href="#main">Skip to content</a><header class="cg-news-header"><a class="cg-news-brand" href="journal.html">Common<br><strong>Ground</strong><span>BY BEYOND BORDERS</span></a><nav aria-label="Publication navigation"><a href="#stories" aria-current="page">Latest</a><a href="common-ground-topics.html">Topics</a><a href="common-ground-standards.html">Editorial approach</a><a href="index.html">Beyond Borders <svg class="link-arrow" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M6 18 18 6M6 6h12v12"/></svg></a></nav></header><div class="cg-topic-bar"><span>Displacement</span><span>Health</span><span>Research</span><span>Community</span></div><main id="main" class="cg-news-main"><header class="cg-cover-heading"><p class="eyebrow">By Beyond Borders</p><h1>Common Ground</h1><p>A student-led publication exploring displacement, health, and access to care.</p></header><section id="stories" aria-label="Common Ground articles"><details class="cg-search-disclosure"><summary>Search the publication</summary><form class="cg-library-tools" role="search" hidden><label>Search the publication<input id="cg-search" type="search" placeholder="Search by topic, title, or author" autocomplete="off"></label><label>Article type<select id="cg-format"><option value="all">All articles</option>{options}</select></label><p id="cg-count" role="status" aria-live="polite">{len(articles)} {'article' if len(articles)==1 else 'articles'}</p></form></details><div class="cg-story-grid">{''.join(card(a) for a in ordered)}</div><p class="cg-no-results" hidden>No articles match your search. Try another word or choose “All articles.”</p></section><section class="cg-contribute"><div><p class="eyebrow">Share your perspective</p><h2>Contribute to Common Ground.</h2><p>Bring your research, experience, or creative work to the conversation on displacement and health. We welcome proposals across disciplines and formats.</p></div><a href="common-ground-contribute.html">Share your idea <svg class="link-arrow" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true"><path d="M6 18 18 6M6 6h12v12"/></svg></a></section><section id="about-publication" class="cg-news-about"><p class="eyebrow">About Common Ground</p><h2>Understanding displacement.<br>Advancing health.</h2><div><p>Led by students and published by Beyond Borders, Common Ground welcomes research, lived experience, and creative perspectives from contributors across disciplines and communities.</p><p>We connect evidence with the realities of people and communities rebuilding their lives.</p><a href="common-ground-standards.html">Our editorial approach <svg class="link-arrow" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M6 18 18 6M6 6h12v12"/></svg></a></div></section></main><footer class="journal-footer"><a href="index.html">Beyond Borders</a><p>Research commentaries are interpretations of published work and are not independently peer reviewed.</p></footer><script src="common-ground.js?v=3"></script></body></html>'''
# The signup page accepts consent-based requests through the existing inbox form.
signup='<section class="cg-subscribe"><p class="eyebrow">New stories by email</p><h2>Get new Common Ground stories by email.</h2><p>Research, perspectives, and visual stories on displacement and health.</p><a href="common-ground-signup.html">Request email updates</a></section>'
...
links=[('journal.html','Latest'),('common-ground-topics.html','Topics'),('common-ground-contribute.html','Contribute'),('index.html','Beyond Borders '+arrow)]
footer='<footer class="journal-footer cg-shared-footer"><a class="cg-footer-brand" href="journal.html">Common Ground<span>By Beyond Borders</span></a><nav aria-label="Footer navigation"><a href="journal.html">Latest</a><a href="common-ground-topics.html">Topics</a><a href="common-ground-standards.html">Editorial approach</a><a href="common-ground-contribute.html">Contribute</a><a href="common-ground-signup.html">Email updates</a><a href="index.html">Beyond Borders '+arrow+'</a></nav><p>Research commentaries interpret published work and are not independently peer reviewed.</p></footer>'
for target in [*ROOT.glob('journal*.html'),*ROOT.glob('common-ground-*.html')]:
    ...
    if 'common-ground-browse.css' not in text:
        text=text.replace('</head>','<link rel="stylesheet" href="common-ground-browse.css?v=3"></head>')
