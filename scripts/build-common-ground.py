...
topic_page=topic_page.replace('<title>Common Ground | A publication by Beyond Borders</title>','<title>Topics | Common Ground</title>').replace('<script src="common-ground.js?v=1"></script>','').replace('href="#stories" aria-current="page"','href="journal.html"')
