...
def card(a):
    ...
    return f'''<article class="cg-story story-{e(a['id'])} {'is-lead' if a is featured else ''}" data-format="{e(a['format'])}" data-search="{e(terms.lower())}"><a class="cg-story-image" href="{e(a['url'])}" aria-label="Read {e(a['title'])}">{art(a)}</a><div class="cg-story-copy"><p class="cg-story-category">{e(a['format'])} <span>· {e(a['topics'][0])}</span></p><h2><a href="{e(a['url'])}">{e(a['title'])}</a></h2><p class="cg-story-summary">{e(a['summary'])}</p><p class="cg-story-meta"><span class="cg-author-name">{e(a['author'])}</span><span class="cg-publish-details"><time datetime="{e(a['date'])}">{label}</time> · {e(a['readingMinutes'])} min read</span></p><a class="cg-story-read" href="{e(a['url'])}">Read the article <span aria-hidden="true">↗</span></a></div></article>'''
